...
import TenantSettingsLayout from '@/layouts/settings/TenantLayout.vue';
...
const submit = () => {
    form.post(tenant.settings.smtp.url(), {
        preserveScroll: true,
        onSuccess: () => {
...
const sendTestEmail = () => {
    router.post(tenant.settings.smtp.test.url(), {}, {
        preserveScroll: true,
        preserveState: true,
    });
};
        ...
        <TenantSettingsLayout>
            <div class="space-y-6">
                <Heading
                    ...
                    description="Configure your email server settings for sending emails to your customers."
                />
